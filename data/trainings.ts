...
export const trainings: Training[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      'Budowanie własnych funkcji umożliwiających złożone, wielokrokowe operacje',
      'Zrozumienie języka M i samodzielna edycja kodu w edytorze zaawansowanym',
    ],
    program: [
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Analitycy danych i specjaliści ds. raportowania',
      'Osoby pracujące na co dzień z danymi',
      'Pracownicy biurowi chcący automatyzować powtarzalne zadania',
      'Osoby zainteresowane łączeniem Excela, AI i automatyzacji',
      'Użytkownicy na poziomie podstawowym i średniozaawansowanym (wymagana podstawowa znajomość Excela)',
    ],
    benefits: [
      'Znaczne ograniczenie pracy manualnej w Excelu',
      'Szybsza analiza danych i tworzenie raportów',
      'Większa dokładność i mniejsze ryzyko błędów',
      'Sprawniejsze rozwiązywanie złożonych problemów',
      'Zwiększenie produktywności w codziennej pracy',
      'Praktyczne umiejętności możliwe do natychmiastowego zastosowania',
      'Lepsze zrozumienie nowoczesnych narzędzi AI w środowisku biznesowym',
    ],
    program: [
      {
        title: 'Moduł 1 – AI w Excelu',
        items: [
          'Wprowadzenie do sztucznej inteligencji i jej roli w Excelu',
          'Dobre praktyki korzystania z AI oraz aspekty bezpieczeństwa',
          'Tworzenie własnego chatbota wspierającego użytkowników Excela',
          'Dostosowanie chatbota do struktury arkusza i kontekstu biznesowego',
          'Narzędzia AI wykorzystywane w pracy z Excelem',
          'Automatyzacja zadań w Excelu przy użyciu AI',
          'Generowanie i optymalizacja formuł z wykorzystaniem AI',
          'Automatyczne czyszczenie i transformacja danych z użyciem AI',
        ],
      },
      {
        title: 'Moduł 2 – VBA i automatyzacja z AI',
        items: [
          'Wprowadzenie do makr i koncepcji automatyzacji procesów',
          'Nagrywanie pierwszych makr i podstawowa edycja kodu',
          'Przegląd edytora VBA oraz struktury prostych procedur',
          'Tworzenie makr automatyzujących powtarzalne zadania',
          'Wsparcie pracy z VBA przy użyciu AI – generowanie, analiza i optymalizacja kodu',
          'Warsztaty praktyczne – budowa własnych rozwiązań łączących formuły, makra i AI',
          'Zaawansowane wykorzystanie AI w formułach, przetwarzaniu danych i automatyzacji',
          'Praktyczne scenariusze łączące AI, formuły i VBA w jednym procesie',
          'Analiza i interpretacja wyników generowanych przez AI w kontekście biznesowym',
        ],
      },
    ],
    faq: [
