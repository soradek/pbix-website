...
export const trainings: Training[] = [
  {
    ...
    faq: [
      { q: 'Dla kogo przeznaczone są szkolenia Power BI?', a: 'Szkolenia kieruję do zespołów analitycznych, finansowych, sprzedażowych, kontrolingowych i wszystkich, które pracują z danymi. Są dostępne zarówno dla zespołów zaczynających przygodę z Power BI, jak i tych chcących usystematyzować i pogłębić swoją wiedzę.' },
  ...
  },
  {
    ...
    description: 'Szkolenie Microsoft DAX wprowadza zespół w świat języka Data Analysis Expressions – narzędzia niezbędnego do budowania zaawansowanych modeli analitycznych w Power BI. Pracownicy zdobędą umiejętność tworzenia precyzyjnych miar, kolumn obliczeniowych oraz złożonych wyrażeń, które pozwolą wyciągnąć z danych znacznie więcej niż standardowe wizualizacje.',
    targetAudience: [
      'Analitycy potrzebujący narzędzi do budowania rozbudowanych raportów i wielowymiarowych analiz',
      'Zespoły pracujące z Power BI Desktop, rozwijające umiejętności zaawansowanego modelowania danych',
  ...
  },
  {
    ...
    description: 'Szkolenie Microsoft Power Query to kurs dla zespołów, które chcą w pełni zapanować nad procesem przygotowywania danych w Power BI. Pracownicy poznają edytor Power Query od środka – nauczą się automatyzować pobieranie danych, czyścić je ze źródeł tak różnych jak Excel, bazy SQL czy pliki PDF, a także łączyć i przekształcać dane z wielu heterogenicznych źródeł bez ręcznej ingerencji.',
    targetAudience: [
      'Zespoły regularnie pracujące z Power BI, szukające narzędzi do zaawansowanego przekształcania danych',
      'Działy chcące zautomatyzować przygotowywanie danych z wielu heterogenicznych źródeł',
      'Analitycy pracujący z niekompletnymi lub nieustrukturyzowanymi zbiorami danych',
      'Zespoły, które chcą wyeliminować ręczne czyszczenie danych z Excela',
    ],
    benefits: [
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Pracownicy przygotowujący się do kursów na poziomie średniozaawansowanym lub zaawansowanym',
      'Zespoły chcące pracować sprawniej i bez stresu z danymi liczbowymi',
    ],
    benefits: [
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Działy finansów, sprzedaży i raportowania chcące zwiększyć produktywność',
      'Pracownicy przygotowujący się do szkolenia z poziomu zaawansowanego lub Power Query',
    ],
    benefits: [
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Zespoły chcące budować profesjonalne dashboardy bezpośrednio w Excelu',
      'Pracownicy planujący rozszerzyć kompetencje o Power Query i Power Pivot',
    ],
    benefits: [
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Zespoły IT i administratorzy danych pracujący z Excelem jako platformą operacyjną',
      'Pracownicy zainteresowani programowaniem bez wcześniejszego doświadczenia w kodowaniu',
    ],
    benefits: [
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Zespoły analityczne chcące zautomatyzować przygotowywanie danych bez znajomości VBA',
      'Działy finansów, HR i sprzedaży przetwarzające dane z ERP, CSV lub zewnętrznych baz',
    ],
    benefits: [
  ...
  },
  {
    ...
    description: 'Szkolenie Microsoft SQL Server to praktyczny kurs pisania zapytań SQL dla zespołów analitycznych, specjalistów BI i działów, które chcą sprawnie pobierać i analizować dane z relacyjnych baz danych. Pracownicy poznają środowisko SQL Server Management Studio, opanują składnię SELECT od podstaw do podzapytań i wyrażeń CTE, a także nauczą się modyfikować dane i rozumieć podstawy wydajności zapytań.',
    targetAudience: [
      'Analitycy danych i specjaliści BI pobierający dane z baz na potrzeby raportów i dashboardów',
      'Zespoły pracujące z Power BI i Excelem, chcące samodzielnie pisać zapytania do źródeł danych SQL',
      'Działy finansów, sprzedaży i operacji korzystające z danych z systemów ERP',
      'Zespoły bez doświadczenia SQL, które chcą nauczyć się go od zera w kontekście biznesowym',
    ],
    benefits: [
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Zespoły BI szukające sposobu na szybkie prototypowanie raportów w Excelu',
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Zespoły tworzące materiały szkoleniowe, oferty handlowe i raporty cykliczne',
      'Pracownicy, których prezentacje są "poprawne", ale chcą je uczynić naprawdę przekonującymi',
    ],
    benefits: [
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Zespoły chcące skrócić czas produkcji raportu od danych do gotowej prezentacji',
      'Pracownicy, dla których spójność wizualna i profesjonalizm materiałów ma znaczenie strategiczne',
    ],
    benefits: [
  ...
  },
  {
    ...
    targetAudience: [
      ...
      'Zespoły biurowe chcące zautomatyzować powtarzalne czynności',
      'Pracownicy, którzy słyszeli o AI, ale nie wiedzą, jak praktycznie ją zastosować w pracy',
