...
export const localHubs: LocalHub[] = [
  {
    ...
    category: 'Excel',
    name: 'Excel',
    metaTitle: 'Szkolenia Excel Poznań i Wielkopolska dla firm',
    metaDescription:
  ...
  },
  {
    ...
    category: 'Power BI',
    name: 'Power BI',
    metaTitle: 'Szkolenia Power BI Poznań i Wielkopolska dla firm',
    metaDescription:
  ...
  },
  {
    ...
    category: 'SQL',
    name: 'SQL',
    metaTitle: 'Szkolenia SQL Poznań i Wielkopolska dla firm',
    metaDescription:
